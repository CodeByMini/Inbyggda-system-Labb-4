...
#define EEPROM_ADDR 0xA0       //160 = 0b10100000 1010 are controlbits for the 24AA02UID

enum RW{WRITE = 0, READ = 1};
...
void eeprom_sequential_write(uint8_t addr, char *datat, size_t length);
